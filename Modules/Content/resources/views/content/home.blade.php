                    ...
                    <div class="card mb-3" data-content-id="{{ $content->id }}">
                        ...
                        <div class="card-body">
                            ...
                            @if (auth()->check())
                                ...
                                @endphp
                                <button class="btn btn-primary like-button" style="{{ $userLiked ? 'display:none;' : '' }}">Like</button>
                                <button class="btn btn-secondary unlike-button" style="{{ $userLiked ? '' : 'display:none;' }}">Unlike</button>
                            @else
                                <button class="btn btn-primary like-button">Like</button>
                                <button class="btn btn-secondary unlike-button" style="display:none;">Unlike</button>
                            @endif
                        </div>
                    </div>
